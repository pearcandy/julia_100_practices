...
# ╔═╡ 17a320ea-f7cf-11eb-2235-c16b00505ee9
using Yao, YaoPlots

# ╔═╡ 0fcab877-7c1b-4595-a0b6-14fca5b042e0
begin
...
# ╔═╡ 53f4904f-3877-484b-b4a3-d2900edcf6d6
begin
    bellcircuit = Yao.chain(2, put(1=>H), control(1, 2=>X))
    plot(bellcircuit)
end

# ╔═╡ 700b9ba3-5182-4132-b2a3-0c4bfee5d9a9
q1 = ArrayReg(bit"00") #creating the system of two qubits with state |00>.

# ╔═╡ ed811b35-4868-4165-ba0a-24c527740a71
Yao.state(q1)

# ╔═╡ c3c2671a-5b14-4bbe-91fa-eccb1f35c83f
Yao.state(ArrayReg(bit"00") + ArrayReg(bit"11")|> normalize!) #Equivalent to (1/√2)*(|00>+|11>)

# ╔═╡ 4cd5a78b-d3b9-4caf-a04d-8fb622513a7b
Yao.state(zero_state(2))

# ╔═╡ 2fda1210-f2b1-47d8-bb6c-8220a0af3ddb
a = (q1 |> bellcircuit) 

# ╔═╡ ed674413-8806-4e8b-9279-c551cd45b417
Yao.state(a)

# ╔═╡ a1655794-ca8e-449f-b26f-a53053cfbea7
#Reverse Belle State
begin
...
# ╔═╡ 4d30c6b0-53c7-4b5b-ae88-d763dd1722f3
res = (a |> reversebellcircuit)

# ╔═╡ 3515e818-9826-4e1e-9582-4a72749ff302
Yao.state(res)

# ╔═╡ a3b00435-9fd0-4d49-98fe-5f008c12c957
# X-single qubit
begin
...
# ╔═╡ cd0a6be2-9afa-41f1-a554-4190df9761bc
begin
...
# ╔═╡ ff28c75d-5150-48b9-a473-93c0b67502b7
measuredqubits = re |> r->measure(r, nshots=1024)

# ╔═╡ 7a0c09c8-468f-4824-a454-fa187a00fe49
plotmeasure(measuredqubits)

# ╔═╡ 6cc80813-ac29-4c6e-9643-4743aa5fcf2d


# ╔═╡ baca549d-48da-4304-83ea-2eeb032d8766


# ╔═╡ 7653d6c7-8712-4b92-b342-016de422d024
